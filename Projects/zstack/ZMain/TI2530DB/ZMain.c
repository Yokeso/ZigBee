...
#ifdef LCD_SUPPORTED 
  HalLcdWriteString( "Yokeso", HAL_LCD_LINE_1 );
  HalLcdWriteString( (char*)lcd_buf, HAL_LCD_LINE_2 );
#endif // LCD_SUPPORTED

#ifdef HAL_UART_TEST 
  HalUARTWrite(HAL_UART_PORT_0, "IEEE: ", strlen("IEEE: "));
  HalUARTWrite(HAL_UART_PORT_0, lcd_buf, (Z_EXTADDR_LEN*2));
  HalUARTWrite(HAL_UART_PORT_0, "\n", strlen("\n"));
#endif // HAL_UART  
  
#endif // LCD_SUPPORTED || HAL_UART_TEST
}
