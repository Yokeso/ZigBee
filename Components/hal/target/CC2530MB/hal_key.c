...
/* edge interrupt */
#define HAL_KEY_SW_7_EDGEBIT  BV(1) /* P1.0 - P1.3中断边沿控制位 */
#define HAL_KEY_SW_7_EDGE     HAL_KEY_FALLING_EDGE

/* SW_7 interrupts */
#define HAL_KEY_SW_7_IEN      IEN2  /* P1口中断屏蔽寄存器 */
#define HAL_KEY_SW_7_IENBIT   BV(4) /* 针对P1口的中断屏蔽控制位 */
...
/* edge interrupt */
#define HAL_KEY_SW_5_EDGEBIT  BV(1) /* P1.0 - P1.3中断边沿控制位 */
#define HAL_KEY_SW_5_EDGE     HAL_KEY_FALLING_EDGE

/* SW_5 interrupts */
#define HAL_KEY_SW_5_IEN      IEN2  /* P1口中断屏蔽寄存器 */
#define HAL_KEY_SW_5_IENBIT   BV(4) /* 针对P1口的中断屏蔽控制位 */
...
/* edge interrupt */
#define HAL_KEY_JOY_MOVE_EDGEBIT  BV(0) /* P0.0 - P0.7中断边沿控制位 */
#define HAL_KEY_JOY_MOVE_EDGE     HAL_KEY_FALLING_EDGE

/* Joy move interrupts */
#define HAL_KEY_JOY_MOVE_IEN      IEN1  /* P0口中断屏蔽寄存器 */
#define HAL_KEY_JOY_MOVE_IENBIT   BV(5) /* 针对P0口的中断屏蔽控制位 */
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
    ...
    else    /* Interrupts NOT enabled */
    {
        ...
        osal_set_event(Hal_TaskID, HAL_KEY_EVENT);    /* 设置按键事件 */
    }
