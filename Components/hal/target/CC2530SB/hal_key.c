...
/* SW_5(OK) is at P2.0 */
#define HAL_KEY_SW_5_PORT   P2
#define HAL_KEY_SW_5_BIT    BV(0)
#define HAL_KEY_SW_5_SEL    P2SEL
#define HAL_KEY_SW_5_DIR    P2DIR
...
#define HAL_KEY_SW_5_IENBIT   BV(1) /* Mask bit for all of Port_2 */
#define HAL_KEY_SW_5_ICTL     P2IEN /* Port Interrupt Control register */
#define HAL_KEY_SW_5_ICTLBIT  BV(0) /* P2IEN - P2.0 enable/disable bit */
#define HAL_KEY_SW_5_PXIFG    P2IFG /* Interrupt flag at source */
