...
#define HAL_KEY_SW_2 0x02  // Joystick right(Relay Control)
#define HAL_KEY_SW_5 0x04  // Joystick center(OK)
#define HAL_KEY_SW_4 0x08  // Joystick left(Motor Control)
#define HAL_KEY_SW_3 0x10  // Joystick down
#define HAL_KEY_SW_6 0x20  // Button S1 if available
#define HAL_KEY_SW_7 0x40  // Button S2 if available(CANCEL)
...
#define HAL_KEY_OK     0x04  // Button OK
#define HAL_KEY_CANCEL 0x40  // Button CANCEL
